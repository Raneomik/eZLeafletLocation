<?php
//
// Definition of eZLeafletLocation class
//
...
/**
 * File containing the eZLeafletLocation class.
 *
 * @package eZDatatype
 */

/**
 * Helper class used along with the eZLeafletLocationType datatype.
 * Provides a datatype for storing latitude & longitude values.
 *
 * @package eZDatatype
 * @see eZLeafletLocation
 */
class eZLeafletLocation extends eZPersistentObject
{
    /*!
    ...
    */
    ...
    /**
     * Create a eZLeafletLocation (but do not store it, thats up to you!)
    ...
    /**
     * Remove a eZLeafletLocation object form database.
     * 
     * @param int $attributeId
